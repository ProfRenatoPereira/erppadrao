...
# ==========================================================================
# O arquivo físico permanece em login/login.js.
# Não usamos /static/login.js porque esse arquivo não existe no projeto.
# ==========================================================================

@login_blueprint.route('/login/login.js', methods=['GET'])
def rota_login_js():
    diretorio_atual = os.path.dirname(os.path.abspath(__file__))
    caminho_login_js = os.path.join(diretorio_atual, 'login.js')

    try:
        with open(caminho_login_js, 'r', encoding='utf-8') as arquivo:
        ...
        return (
            "console.error('Erro Crítico: arquivo login.js não encontrado.');",
            404,
            {'Content-Type': 'application/javascript; charset=utf-8'}
        )
